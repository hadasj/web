...
public class Greetings {
	...
	public void printGreetings(final PrintWriter writer, final String serverInfo, final Map<String, String[]> parameters) {
		try {
			...
			printInfo(writer, serverInfo, parameters.get(USER_PARAMETER));
	...
	private void printInfo(final PrintWriter writer, final String serverInfo, final String[] userParameters) {
		...
		writer.println("<B> User: " + user + "</B><BR/>");
